...
| 03i | `03i-scene-preview-player.md` | scene preview player — flipbook of filmstrip frames + narration stitched via Web Audio scheduling, simulating `planScene()` with **no ffmpeg**; modal `<dialog>` beside Assemble | ✅ implemented (pending PR) |
