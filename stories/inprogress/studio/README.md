...
Replicate **WhisperX** (`align_output:true` for word timestamps); MSW mock
removed. ⚠️ Needs the **Replicate API token** set in BFFless Settings → AI before
it returns. **Next up: Story 03 — shorten + scene-split.**
