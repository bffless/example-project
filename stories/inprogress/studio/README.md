...
| 03l | `03l-scene-prompt-context.md` | per-scene refine direction + director-prompt passthrough (persisted `direction`, include-checkbox, two labeled fields to rule `afacb572`) — absorbs 03f Part B | 📝 spec ready |
