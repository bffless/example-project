...
**The `studio/projects` initiative (stories 11a–11d) is nearly complete.** Stories
11a, 11b, and 11c have all shipped: 11a introduced projects as first-class entities
...
**11d (server-side project sync — projects survive clearing localStorage) is the
last story in the initiative, queued next.**
